...
<div class="d-flex align-items-center mb-4">
    ...
    <h1 class="h3 mb-0">New Store / Site</h1>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                        <option value="site" @selected(old('type') == 'site')>Project Site</option>
                        <option value="warehouse" @selected(old('type') == 'warehouse')>Central Warehouse</option>
                        <option value="yard" @selected(old('type') == 'yard')>Equipment Yard</option>
                    </select>
